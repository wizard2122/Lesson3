...
public class AngelHealth : IHealthStat
{
    ...
    private int _additionaHeal;

    private MonoBehaviour _context;
    private Coroutine _heal;

    public AngelHealth(IHealthStat healthStat, float healDuration, int additionaHeal, MonoBehaviour context)
    {
        _healthStat = healthStat;
        _healDuration = healDuration;
        _additionaHeal = additionaHeal;
        _context = context;
    }
    ...
    private IEnumerator Heal()
    {
        ...
        int healPerTick = _additionaHeal / TicksCount;
